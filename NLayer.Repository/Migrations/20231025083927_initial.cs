        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductFeatures_Procuts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Procuts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 25, 11, 39, 27, 570, DateTimeKind.Local).AddTicks(300), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2023, 10, 25, 11, 39, 27, 570, DateTimeKind.Local).AddTicks(310), "Kalem 2", 200m, 30, null },
                    { 3, 1, new DateTime(2023, 10, 25, 11, 39, 27, 570, DateTimeKind.Local).AddTicks(311), "Kalem 3", 600m, 60, null },
                    { 4, 2, new DateTime(2023, 10, 25, 11, 39, 27, 570, DateTimeKind.Local).AddTicks(312), "Kitap 1", 600m, 60, null },
                    { 5, 2, new DateTime(2023, 10, 25, 11, 39, 27, 570, DateTimeKind.Local).AddTicks(313), "Kitap 2", 6600m, 320, null }
                });
